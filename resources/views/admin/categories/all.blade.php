                ...
                @can("create-category")
                    <div class="flex">
                        <a href="{{route("admin.categories.create")}}"
                           class="p-3 rounded-lg bg-blue-600 hover:bg-blue-800 text-white  mt-9 mr-4 ">ثبت دسته بندی
                            جدید</a>
                        ...
                        <tr>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                ...
                                <img alt="{{$category->name}}"
                                     src="{{asset($category->icon )?? asset("images/category.png")}}"
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                @foreach($category->placeTypes as $placeType)
                                    {{$placeType->name}},
                                @endforeach
                            </td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
