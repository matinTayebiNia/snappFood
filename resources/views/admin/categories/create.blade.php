    ...
    <div class="flex flex-wrap w-full  flex-col px-4 py-8 bg-white rounded-lg shadow  sm:px-6 md:px-8 lg:px-10">
        ...
        <div class="p-6 mt-8">
            <div class="w-full rounded-lg block">
                ...
                <form action="{{route("admin.categories.store")}}" enctype="multipart/form-data" class="w-full"
                      method="post">
                    @csrf
...
"
                                   ...
                                   name="icon" value="{{old("icon")}}" placeholder="عکس دسته بندی">
                            <p class=" text-red-700 m-3 font-semibold">
...
"
                                    ...
                                    name="type">
                                <option value=""></option>
                                <option value="ForRestaurant" {{old("type")=="ForRestaurant"?"selected":""}} >برای
                                    رستوران
                                </option>
                                <option value="ForFood" {{old("type")=="ForFood"?"selected":""}} >برای غذا</option>
                            </select>
                            <p class=" text-red-700 m-3 font-semibold">
