    ...
    <div class="flex flex-wrap w-full  flex-col px-4 py-8 bg-white rounded-lg shadow  sm:px-6 md:px-8 lg:px-10">
        ...
        <div class="p-6 mt-8">
            <div class="w-full rounded-lg block">
                ...
                <form action="{{route("admin.discounts.update",$discount->id)}}" method="post" class="w-full">
                    @csrf
                    @method("PATCH")
...
"
                                ...
                                <option value="money" {{old("typeDiscount",$discount->typeDiscount)=="money"?"selected":""}} >پول</option>
                                <option value="Percentage" {{old("typeDiscount",$discount->typeDiscount)=="Percentage"?"selected":""}} >درصد</option>
                            </select>
                            <p class=" text-red-700 m-3 font-semibold">
