...
<div class="flex items-start justify-between">
    <x-SideBarAdmin>
        ...
        <x-SideBarAdminItem :route="route('owner.reports.index')"
                            itemName="گزارشات"
                            isActive=""
                            icon='<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 192.287 192.287" style="enable-background:new 0 0 192.287 192.287;" xml:space="preserve">
<g>
