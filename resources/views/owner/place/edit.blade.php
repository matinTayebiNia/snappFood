    ...
    <div class="flex flex-wrap w-full  flex-col px-4 py-8 bg-white rounded-lg shadow  sm:px-6 md:px-8 lg:px-10">
        ...
        <div class="p-6 mt-8">
            <div class="w-full rounded-lg block">
                ...
                <form action="{{route("owner.placesOwner.update",auth()->user()->place->id)}}" method="post" class="w-full">
                    @csrf
                    @method("PATCH")
...
"
                                   value="{{old("name",auth()->user()->place->name)}}"
                            ...
                            <input id="Number" type="number"
                                   class="
                                                   ...
                                                   w-full md:w-1/2 py-2 px-4 bg-white
                                                    ...
                                                    focus:border-transparent
"
                                   value="{{old("Number",auth()->user()->place->Number)}}"
                            ...
                            <input id="account_number" type="number"
                                   class="
                                                   ...
                                                   w-full md:w-1/2 py-2 px-4 bg-white
                                                    ...
                                                    focus:border-transparent
"
                                   value="{{old("account_number",auth()->user()->place->account_number)}}"
                            ...
                            <input id="state" type="text"
                                   class="
                                                   ...
                                                   w-full md:w-1/2 py-2 px-4 bg-white
                                                    ...
                                                    focus:border-transparent
"
                                   value="{{old("state",auth()->user()->place->address->state)}}"
                            ...
                            <input id="city" type="text"
                                   class="
                                                   ...
                                                   w-full md:w-1/2 py-2 px-4 bg-white
                                                    ...
                                                    focus:border-transparent
"
                                   value="{{old("city",auth()->user()->place->address->city)}}"
                            ...
                            <input id="street" type="text"
                                   class="
                                                   ...
                                                   w-full md:w-1/2 py-2 px-4 bg-white
                                                    ...
                                                    focus:border-transparent
"
                                   value="{{old("street",auth()->user()->place->address->street)}}"
                            ...
                            <input id="pluck" type="text"
                                   class="
                                                   ...
                                                   w-full md:w-1/2 py-2 px-4 bg-white
                                                    ...
                                                    focus:border-transparent
"
                                   value="{{old("pluck",auth()->user()->place->address->pluck)}}"
                        ...
                        <div class=" relative ">
                            ...
                            <select class="js-example-basic-single w-1/2" id="types" multiple
                                ...
                                @foreach(\App\Models\PlaceType::all() as $type)
                                    <option
                                        value="{{$type->id}}"
                                        {{in_array($type->id,auth()->user()->place->placetypes->pluck("id")->toArray())?"selected":""}}>
                                        {{$type->name}} </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class=" relative ">
                            ...
                            <select class="js-example-basic-single w-1/2" id="categories" multiple
                                ...
                                @foreach(\App\Models\Category::all() as $category)
                                    <option
                                        value="{{$category->id}}"
                                        {{in_array($category->id,auth()->user()->place->categories->pluck("id")->toArray())?"selected":""}}>
